...
| Relbase | OAuth, sondas controladas, mapeo de SKU, stock y flujo tributario desarrollados | Ejecutar un piloto, aprobar reglas con el contador y habilitar por etapas la autoridad de stock y la emisión automática |
